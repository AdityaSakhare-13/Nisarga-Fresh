      ...
      <section className="relative h-screen w-full flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
          ...
          >
            ...
            <h1 className="text-white text-6xl md:text-8xl font-serif leading-[1.1] mb-8">
              Elevating the <br />
            ...
            <p className="text-slate-300 text-lg md:text-xl font-light mb-12 leading-relaxed max-w-xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0">
            {stats.map((stat, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-center lg:border-r border-white/10 px-4 last:border-r-0"
              >
